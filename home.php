...
<!-- Page content -->
<div class="w3-cell-row" style="margin-top: 70px">
<!--<div class=" w3-content" style="max-width:1350px; margin-top: 70px">-->
<marquee><h2>CAR MAGAZINE</h2></marquee>
  ...
  <!-- Automatic Slideshow Images -->
    ...
    $sql = "SELECT image,model FROM newcar  LIMIT 5";
...
?>
     <div class="mySlides w3-display-container w3-center w3-col.l6 w3-twothird">
<figure>
  <img src="images/<?php echo $post['image']; ?>"  class="img-set">
  <figcaption class="caption">
  <a href="Welcome.php" name=""><?php echo $post['model'];?> </a>
  </figcaption>
</figure>
    </div>
    <?php }
...
<!--share vedio -->
<div class="w3-col.s4 w3-third ifr">
<iframe width="100%" height="420" src="https://www.youtube.com/embed/A9EoOj9Uk6o" frameborder="0" allowfullscreen></iframe>
  </div>
 ...
 <div class="w3-container">
  <?php
    ...
    $sql = "SELECT image,model FROM newcar WHERE features='front' LIMIT 6";
   $result= mysqli_query($dbcon,$sql);
...
?>   
    <div class="w3-col.s4 w3-third">
     <div class='wrapper12'>  
    <!-- image -->  
    <img src="images/<?php echo $post['image']; ?> " width="100%" height="200px" />  
    <!-- description div -->  
    <div class='description'>  
        <!-- description content -->  
        <p class='description_content'><a href="Welcome.php" name=""><?php echo $post['model'];?> </a></p>  
